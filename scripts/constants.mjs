...
export const DEFAULT_RANKS = [
   { name: "Private", abbr: "Pvt.", icon: "assets/1.png" },
   { name: "Corporal", abbr: "Cpl.", icon: "assets/2.png" },
   { name: "Sergeant", abbr: "Sgt.", icon: "assets/3.png" },
   { name: "Master Sergeant", abbr: "MSgt.", icon: "assets/4.png" },
   { name: "First Lieutenant", abbr: "1st Lt.", icon: "assets/5.png" },
   { name: "Second Lieutenant", abbr: "2nd Lt.", icon: "assets/6.png" },
   { name: "Captain", abbr: "Cpt.", icon: "assets/7.png" },
   { name: "Major", abbr: "Maj.", icon: "assets/8.png" },
   { name: "Colonel", abbr: "Col.", icon: "assets/9.png" },
   { name: "General", abbr: "Gen.", icon: "assets/10.png" },
]

export const rankIconPath = (icon) =>
   icon
      ? icon.startsWith("assets/")
         ? `modules/${MODULE_ID}/${icon}`
         : icon
      : `modules/${MODULE_ID}/assets/1.png`

export const SIZE_BULK = {
   tiny: 1,
   sm: 3,
   med: 6,
   lg: 12,
...
export const CROWN_IMG = "icons/equipment/head/crown-gold-blue.webp"
...
export const ACTION_TEMPLATES = {
   aiming: {
      ...
      skills: [{ name: "perception", loreName: "", dc: "" }],
   },
   loading: {
   ...
   repair: {
      nameKey: "ActionTemplates.Repair.Name",
      descKey: "ActionTemplates.Repair.Desc",
      img: "icons/skills/trades/plating-metal-welding-steel.webp",
      skills: [{ name: "crafting", loreName: "", dc: "" }],
      traits: "manipulate",
      siegeAction: { isRepair: true },
   },
   repairShields: {
      nameKey: "Shield.RepairShieldsAction",
      descKey: "Shield.RepairShieldsDesc",
      img: "icons/tools/smithing/furnace-fire-metal-orange.webp",
      skills: [{ name: "crafting", loreName: "", dc: "" }],
      traits: "manipulate",
      siegeAction: { isRepairShields: true },
   },
   moving: {
   ...
   carryInConcert: {
      nameKey: "ActionTemplates.CarryInConcert.Name",
      descKey: "ActionTemplates.CarryInConcert.Desc",
   ...
   drivingManoeuvre: {
      nameKey: "ActionTemplates.DrivingManoeuvre.Name",
      descKey: "ActionTemplates.DrivingManoeuvre.Desc",
      img: "icons/skills/movement/arrow-down-pink.webp",
      actionsCost: 1,
      skills: [
         { name: "lore", loreName: "piloting", dc: "" },
         { name: "lore", loreName: "combat-vehicles", dc: "" },
         { name: "lore", loreName: "vehicles", dc: "" },
         { name: "lore", loreName: "driving", dc: "" },
      ],
   },
   openStorage: {
      nameKey: "ActionTemplates.OpenStorage.Name",
      descKey: "ActionTemplates.OpenStorage.Desc",
      actionsCost: 1,
      skills: [],
   },
   launch: {
      nameKey: "ActionTemplates.Launch.Name",
      descKey: "ActionTemplates.Launch.Desc",
      actionsCost: 1,
      skills: [],
   },
}
...
export const TRAIT_LORE_SKILLS = {
   [VEHICLE_TRAITS.COMBAT_VEHICLE]: {
      name: "lore",
      loreName: "combat-vehicles-lore",
      dc: "",
   },
   [VEHICLE_TRAITS.ARTILLERY]: {
      name: "lore",
      loreName: "artillery-lore",
      dc: "",
   },
}

export const ENTERABLE_POSITIONS = {
   DRIVER: "Driver",
   OPERATOR: "Operator",
}
...
export const ATTACK_TEMPLATES = {
   ...
   strikeInConcert: {
      nameKey: "AttackTemplates.StrikeInConcert.Name",
      descKey: "AttackTemplates.StrikeInConcert.Desc",
      skills: [],
      prereqs: [{ name: "Lifted", count: 1 }],
      isStrike: true,
      actionType: "",
      traits: "manipulate",
