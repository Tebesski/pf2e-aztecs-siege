...
const byVeh = this.actor.getFlag(MODULE_ID, "rankByVehicle") || {}
   ...
   _portrait() {
      ...
      return normalizePortraitData(cp, this.actor.img)
   }
      ...
      return `
         <div class="siege-crew-dossier">
            <div class="scd-header">
               <div class="scd-portrait" data-action="open-sheet" title="${tKey("CrewHUD.OpenSheet")}" style="cursor:pointer;">
                  ${
                     portrait.backgroundSrc
                        ? `<img class="scd-portrait-bg" src="${portrait.backgroundSrc}" style="${portraitBackgroundImgStyle(portrait)}">`
                        : ""
                  }
                  <img class="scd-portrait-img" src="${portrait.src}" style="${portraitImgStyle(portrait)}">
               </div>
               <div class="scd-id">
